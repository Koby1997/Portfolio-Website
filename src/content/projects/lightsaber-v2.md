---
title: "Lightsaber V2"
description: "Made another lightsaber with updated electronics for better color/sounds."
categories: ["Hardware"]
pubDate: 2023-08-01
coverImage: "/assets/projects/lightsaber/v2/HeroVid.mp4"
mediaFolder: "/assets/projects/lightsaber/v2"
demoMode: true
---
...
<li>
<span class="text-white font-bold block text-lg mb-1">Upgraded Electronics</span>
<span class="text-zinc-400 text-sm leading-relaxed">Verso V2.0 FX Lightsaber Soundboard</span>
</li>
<li>
<span class="text-white font-bold block text-lg mb-1">Easy setting changes</span>
<span class="text-zinc-400 text-sm leading-relaxed">Blade color, sound, and pulse intensity. </span>
</li>
<li>
<span class="text-white font-bold block text-lg mb-1">Improved Aesthetics</span>
<span class="text-zinc-400 text-sm leading-relaxed">Realistic metal finish and worn/used look.</span>
</li>
</ul>
</div>
</div>
...
<h3 class="text-4xl font-bold text-white">The Raw Hilt</h3>
