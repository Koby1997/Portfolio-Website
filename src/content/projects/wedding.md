...
pubDate: 2022-12-01
coverImage: "/assets/projects/wedding/Dip.JPG"
mediaFolder: "/assets/projects/wedding"
demoMode: true
---
...
<div class="md:col-span-12 flex flex-col justify-center border-l-2 border-purple-500 pl-8">
<h2 class="text-xs font-mono tracking-[0.4em] text-purple-400 mb-6 uppercase">Overview</h2>
<p class="text-zinc-300 text-2xl leading-relaxed font-light md:max-w-4xl">
No real need for an overview here. Just enjoy some photos from the big day!
</p>
</div>
</div>
