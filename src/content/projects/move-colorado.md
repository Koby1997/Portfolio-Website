...
<img src="/assets/projects/move-colorado/LastSupper.jpeg" class="w-full h-auto max-w-4xl rounded-2xl shadow-2xl overflow-hidden object-cover" />
</div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-12 gap-12 items-center mb-12">
<div class="md:col-span-12 flex justify-center">
<img src="/assets/projects/move-colorado/Leaving.jpeg" class="w-full h-auto max-w-2xl rounded-2xl shadow-2xl overflow-hidden object-cover" />
</div>
</div>
</div>
</section>
